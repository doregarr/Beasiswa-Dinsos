...
<input type="text" placeholder="Masukkan Nomor Induk Kependudukan" class="input3">
<br>
<input type="text" placeholder="Masukkan Nama" class="input3">
<input type="text" placeholder="Masukkan Email" class="input3">
<div class="btn-login">
<input type="password" placeholder="Masukkan Password" class="input3">
